...
# Load data
# --------------------------------------------------------------
df = pd.read_pickle("../../data/interim/02_outliers_removed_df_chauvenet.pkl")
...
sample_df = FreqAbs.abstract_frequency(df_freq, ["acc_y"], window_size, sampling_rate)
subset = sample_df[sample_df["set"] == 15]
